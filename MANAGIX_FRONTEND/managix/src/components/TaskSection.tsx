...
import { FiBriefcase, FiPlus, FiUploadCloud, FiCheckCircle, FiClock } from 'react-icons/fi';
              ...
              <form onSubmit={handleCreateTask} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <select className="w-full p-4 bg-gray-50 border-2 border-transparent focus:border-indigo-600 focus:bg-white rounded-2xl outline-none appearance-none" required value={selectedTeamId} onChange={e => setSelectedTeamId(e.target.value)}>
                ...
                <div className="flex gap-4 pt-6">
                  ...
                  <button type="button" onClick={() => setShowTaskModal(false)} className="flex-1 bg-gray-100 text-gray-800 py-4 rounded-2xl font-black hover:bg-gray-200 transition-all">CANCEL</button>
                </div>
              </form>
            </div>
          </div>
