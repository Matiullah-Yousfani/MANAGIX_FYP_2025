    ...
    return (
        <div className="w-64 h-screen bg-[#0A0A0A] text-white flex flex-col p-0 fixed shadow-2xl border-r border-white/5">
            ...
            <nav className="flex-1 px-4 space-y-1 overflow-y-auto no-scrollbar">
                ...
                {appRole !== 'Admin' && (
                    hasActive ? (
                        <Link to={meetingRoomTo} className={`flex items-center gap-3 p-3 rounded-r-xl transition-all duration-300 ${location.pathname === '/meeting' ? "bg-white/10 text-white border-l-4 border-white font-bold" : "hover:bg-white/5 text-gray-400 hover:text-gray-100 border-l-4 border-transparent"}`}>
                            ...
                            <span className="ml-auto size-2 rounded-full bg-emerald-400 animate-pulse" title="Live" />
                        </Link>
                    ) : (
                        <div
                            className="flex items-center gap-3 p-3 rounded-r-xl border-l-4 border-transparent text-gray-600 opacity-50 cursor-not-allowed"
                ...
                {appRole !== 'Admin' && (
                    <Link to="/meeting/transcripts" className={`flex items-center gap-3 p-3 rounded-r-xl transition-all duration-300 ${isActive('/meeting/transcripts')}`}>
                ...
                {appRole === 'Manager' && (
                    <>
                        ...
                        <Link to="/meeting/summaries" className={`flex items-center gap-3 p-3 rounded-r-xl transition-all duration-300 ${isActive('/meeting/summaries')}`}>
                            <svg className="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>
                ...
                {appRole === 'Employee' && (
                    <>
                        ...
                        <Link to="/my-timesheet" className={`flex items-center gap-3 p-3 rounded-r-xl transition-all duration-300 ${isActive('/my-timesheet')}`}>
                            <svg className="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
