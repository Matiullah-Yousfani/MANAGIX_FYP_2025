        ...
        {activeTab === 'overview' && (
          <div className="bg-white rounded-[2.5rem] border border-[#E5E7EB] p-10 mb-8 shadow-sm">
            ...
            <div className="flex flex-wrap gap-3">
              <button type="button" onClick={() => navigate('/dashboard')} className="px-6 py-3 bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-700">
                Control Center
              </button>
